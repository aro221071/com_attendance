...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_attendance&task=types.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_attendance&view=types'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="typeList">
          ...
          <th width="1%" class="nowrap center">
						<?php echo JHtml::_('grid.sort', 'JNAME', 'a.longname', $listDirn, $listOrder); ?>
					</th>
          
          <th width="1%" class="nowrap center">
						<?php echo JHtml::_('grid.sort', 'JNAME', 'a.shortname', $listDirn, $listOrder); ?>
					</th>
          
          <th width="1%" class="nowrap center">
						<?php echo JHtml::_('grid.sort', 'JNAME', 'a.players_male', $listDirn, $listOrder); ?>
					</th>
          
          <th width="1%" class="nowrap center">
						<?php echo JHtml::_('grid.sort', 'JNAME', 'a.players_female', $listDirn, $listOrder); ?>
					</th>
          
          <th width="1%" class="nowrap center">
						<?php echo JHtml::_('grid.sort', 'JNAME', 'a.players_whatever', $listDirn, $listOrder); ?>
					</th>
          ...
          <td>
            ...
            <?php endif; ?>
            <?php if ($canEdit) : ?>
              <a href="<?php echo JRoute::_('index.php?option=com_attendance&task=type.edit&id='.(int) $item->id); ?>">
            <?php echo $item->longname; ?></a>
            <?php else : ?>
          ...
          <td class="left">
           ...
           <td class="left">
						<?php echo $item->players_male; ?>
					</td>          
         
           <td class="left">
						<?php echo $item->players_female; ?>
					</td>          
         
           <td class="left">
						<?php echo $item->players_whatever; ?>
					</td>          
