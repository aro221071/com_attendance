 ...
 */
class AttendanceViewTypes extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        AttendanceHelper::addSubmenu('types');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_ATTENDANCE_TITLE_TYPES'), 'types.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_attendance&view=types');
